...
###############
#* 
#* Association analysis on cognitive decline predictor 'longitudinal vocabulary'
#* (gvstd_int) using data from the ACPRC cognitive decline cohort study. Using a
...
model = 'glm(gvstd_int ~ term + rcs(p1age,3) + sex,
...
write_csv(HLA_LowRes, '../../write up/Supplementary/SuppTable16_alleleLowRes.csv')
write_csv(HLA_HighRes, '../../write up/Supplementary/SuppTable16_alleleHighRes.csv')
write_csv(HLA_SuperTypes, '../../write up/Supplementary/SuppTable16_alleleSupertypes.csv')
write_csv(NKcell, '../../write up/Supplementary/SuppTable16_FunctionEpitope.csv')
