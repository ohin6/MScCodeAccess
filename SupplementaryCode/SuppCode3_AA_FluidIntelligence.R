...
###############
#* 
#* Association analysis on cognitive decline predictor 'interval fluid intelligence'
#* (gfstd_lin) using data from the ACPRC cognitive decline cohort study. Using a
#* linear regression corrected for age and sex
...
#* Association was observed between Functional Epitope C1/C2 and Bw4 for 
#* vocabulary, albeit just outside signiifcance threshold. See HLA_Supertypes 
#* table
...
model = 'glm(gfstd_int ~ term + rcs(p1age,3) + sex,
...
write_csv(HLA_LowRes, '../../write up/Supplementary/SuppTable17_alleleLowRes.csv')
write_csv(HLA_HighRes, '../../write up/Supplementary/SuppTable17_alleleHighRes.csv')
write_csv(HLA_SuperTypes, '../../write up/Supplementary/SuppTable17_alleleSupertypes.csv')
write_csv(NKcell, '../../write up/Supplementary/SuppTable17_FunctionEpitope.csv')
